...
class Restaurant extends Component{
    ...
    moveBackPart = (id) =>{
        document.getElementById('back_button_steps_3').className = "show_button"; 
        this.setState({
            part_rest:null,
            part_rest_item:true,
        });
    ...
    openRestaurant = (key) =>{
         document.getElementById('back_button_steps_3').className = "hide_button"; 
        this.setState({
            part_rest:key,
    ...
    render(){
        return(
            <div>
                <h2 className= { this.state.part_rest_item ? "item_block_show" : "item_block_hide" }>Private Dining</h2>
                ...
                <Animated animationOut="fadeOut" isVisible={this.props.nextPart == 3 ? true : false}>
